...
/**
* @Author:QJF
* @Date 2018/6/19 11:40
* @Description:
 * 基于 2.3.0版
 * 1、修复了 select 上的 上/下 键的bug；
 * 2、增加了 select 上搜索忽略大写的功能。
*/
                    ...
                    ,events = function(reElem, disabled, isSearch){
                        ...
                        input.on('keyup', function(e){ //键盘松开
                            ...
                            var setThisDd = function(prevNext, thisElem){
                                ...
                                nearDd =  thisElem[prevNext]('dd:not(.layui-hide)'); //当前元素的 dd 元素
                        ...
                        var notOption = function(value, callback, origin){
                            ...
                            layui.each(dds, function(){
                                var othis = $(this)
                                    ,text = othis.text()
                                    ,not = text.toLowerCase().indexOf(value) === -1 && text.toUpperCase().indexOf(value) === -1;
